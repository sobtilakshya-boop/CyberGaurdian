...
const ALL_TIPS: TipEntry[] = [
  ...
  { text: 'Social engineers exploit authority, urgency, and fear. If a "bank" calls asking for your OTP, hang up and call the bank\'s official number directly. Banks never ask for OTPs.', category: 'Social Engineering', categoryColor: '#EF4444' },
  ...
  { text: 'Audit app permissions quarterly. Delete any app you haven't used in 30 days. Every installed app is a potential attack surface with access to your data and sensors.', category: 'Privacy', categoryColor: '#8B5CF6' },
  ...
  { text: 'Request a credit freeze (not just an alert) from all three bureaus — Equifax, Experian, and TransUnion. It\'s free and prevents new credit from being opened in your name.', category: 'Identity', categoryColor: '#6366F1' },
  ...
  { text: 'Deploy an EDR (Endpoint Detection & Response) solution on every device, not just antivirus. EDR detects behavioral anomalies rather than just known malware signatures.', category: 'Defense', categoryColor: '#F59E0B' },
  ...
  { text: 'Check haveibeenpwned.com monthly to see if your email/credentials appear in data breaches. Immediately rotate passwords for any compromised accounts.', category: 'Passwords', categoryColor: '#8B5CF6' },
  ...
  { text: 'Encrypt your storage devices (BitLocker/FileVault/LUKS). A stolen laptop without encryption gives attackers immediate access to all your data, bypassing your login password.', category: 'Encryption', categoryColor: '#10B981' },
  ...
  { text: 'Review your browser extensions rigorously. Extensions have access to all your web traffic. Remove any extension you didn\'t install intentionally or that hasn\'t been updated in 6+ months.', category: 'Privacy', categoryColor: '#8B5CF6' },
  ...
  { text: 'Log out of sessions on shared devices and revoke access tokens manually. JWT tokens don\'t expire until their TTL unless you explicitly invalidate them server-side.', category: 'Sessions', categoryColor: '#EF4444' },
]
